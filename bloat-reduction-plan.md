...
2. [x] **Extract shared text parsing utilities**
...
5. [x] **LLM provider routing simplification**
...
7. [x] **Test bloat reduction for chat route**
...
8. [x] **Targeted API settings cleanup**
...
## Results & Completion (2026-03-17)
- **SearchBar**: Reduced from 445 to 168 lines.
- **ChatService**: Reduced from 364 to 161 lines.
- **Memory**: Reduced from 323 lines to 8 lines (exported wrapper).
- **Stability**: Fixed a critical bug in Perplexity model routing and a streaming buffer truncation issue. All 123 unit tests passing.
