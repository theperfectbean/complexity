...
- **Assistant Message Footer**: Consistently grouped all response-level actions (Copy, Export, Share, Retry, Rewrite) in the message footer.
- **Share Thread**: Added a new "Share" button that copies the thread URL to the clipboard.
