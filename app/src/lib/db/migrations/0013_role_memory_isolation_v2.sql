...
ALTER TABLE "documents" ADD COLUMN IF NOT EXISTS "extracted_text" text;--> statement-breakpoint
...
ALTER TABLE "memories" ADD COLUMN IF NOT EXISTS "role_id" text;--> statement-breakpoint
ALTER TABLE "messages" ADD COLUMN IF NOT EXISTS "memories_used" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "roles" ADD COLUMN IF NOT EXISTS "is_public" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "threads" ADD COLUMN IF NOT EXISTS "parent_thread_id" text;--> statement-breakpoint
ALTER TABLE "threads" ADD COLUMN IF NOT EXISTS "branch_point_message_id" text;--> statement-breakpoint
ALTER TABLE "threads" ADD COLUMN IF NOT EXISTS "system_prompt" text;--> statement-breakpoint
ALTER TABLE "threads" ADD COLUMN IF NOT EXISTS "pinned" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "threads" ADD COLUMN IF NOT EXISTS "tags" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
...
ALTER TABLE "memories" DROP CONSTRAINT IF EXISTS "memories_role_id_fkey";
ALTER TABLE "memories" DROP CONSTRAINT IF EXISTS "memories_role_id_roles_id_fk";
