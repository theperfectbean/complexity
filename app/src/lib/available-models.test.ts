...
describe("available-models", () => {
  ...
  it("normalizes legacy model ids before resolving", async () => {
    await expect(resolveRequestedModel("anthropic/claude-haiku-4-5")).resolves.toBe("anthropic/claude-4-5-haiku-latest");
  });
});
