...
export default function SpacesPage() {
  ...
  if (!session?.user) {
    return (
      <main className="mx-auto max-w-5xl p-6">
        <p>
          Please <Link className="underline" href="/login">sign in</Link> to manage spaces.
        </p>
      </main>
    );
  }
  ...
  return (
    <main className="mx-auto max-w-5xl p-6">
      <h1 className="font-[var(--font-accent)] text-2xl font-semibold">Spaces</h1>
      <p className="mt-2 text-sm text-muted-foreground">Create spaces and manage documents for RAG-enhanced chat.</p>
